...
am_projet6_OBJECTS = main.$(OBJEXT) support.$(OBJEXT) \
	interface.$(OBJEXT) callbacks.$(OBJEXT) \
	yassAjoutRegister.$(OBJEXT) yassVerifLogin.$(OBJEXT) \
	fonctions.$(OBJEXT)
projet6_OBJECTS = $(am_projet6_OBJECTS)
am__DEPENDENCIES_1 =
projet6_DEPENDENCIES = $(am__DEPENDENCIES_1)
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(projet6_SOURCES)
DIST_SOURCES = $(projet6_SOURCES)
...
ACLOCAL = ${SHELL} /home/yass/Projets/projet6/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/yass/Projets/projet6/missing autoconf
AUTOHEADER = ${SHELL} /home/yass/Projets/projet6/missing autoheader
AUTOMAKE = ${SHELL} /home/yass/Projets/projet6/missing automake-1.15
AWK = mawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /home/yass/Projets/projet6/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/yass/Projets/projet6/src
abs_srcdir = /home/yass/Projets/projet6/src
abs_top_builddir = /home/yass/Projets/projet6
abs_top_srcdir = /home/yass/Projets/projet6
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/yass/Projets/projet6/install-sh
...
projet6_LDADD = -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lfontconfig -lfreetype $(INTLLIBS)
all: all-am
...
projet6$(EXEEXT): $(projet6_OBJECTS) $(projet6_DEPENDENCIES) $(EXTRA_projet6_DEPENDENCIES) 
	@rm -f projet6$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(projet6_OBJECTS) $(projet6_LDADD) $(LIBS)
...
include ./$(DEPDIR)/yassAjoutRegister.Po
include ./$(DEPDIR)/yassVerifLogin.Po
